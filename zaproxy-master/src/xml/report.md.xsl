...
| Maximum | <xsl:value-of select="filesize/max"/> |
| Maximum URL | <xsl:value-of select="filesize/maxurl"/> |
...
| Maximum | <xsl:value-of select="filewidth/max"/> |
| Maximum URL | <xsl:value-of select="filewidth/maxurl"/> |
...
| Maximum | <xsl:value-of select="fileheight/max"/> |
| Maximum URL | <xsl:value-of select="fileheight/maxurl"/> |
| Medium | <xsl:value-of select="fileheight/med"/> |
| Average | <xsl:value-of select="fileheight/avg"/> |
